...
var User = "select name, token, phone, email, snils, regAddr, proAddr, doc, admin, layers, dicts, messages from users where token = ?"
var UserList = "select name, token, phone, email, snils, regAddr, proAddr, doc, admin, layers, dicts, messages from users"
var UserGroupList = "select id, name, admin, layers, dicts, messages from user_groups"
...
var UserGroupCreate = "insert into user_groups (name, admin, layers, dicts, messages) values (?, ?, ?, ?, ?)"
var UserGroupUpdate = "update user_groups SET name=?, admin=?, layers=?, dicts=?, messages=? where id=?"
var UserUpdate = "update users SET admin=?, layers=?, dicts=?, messages=? where token=?"
